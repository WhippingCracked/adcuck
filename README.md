...
| File | What it does |
|---|---|
| `1-get-filters.bat` | Asks for a video link, sits through the ads on it, then asks you about each thing it found and adds the ones you approve to `filters.js` |
